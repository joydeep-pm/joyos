/**
 * Generate Mock Data for Product Control Tower Demo
 *
...
async function generateMockData() {
  console.log("Generating mock feature requests...");
  await writeFeatureRequestCache(mockFeatureRequests);
  console.log(`✅ Generated ${mockFeatureRequests.length} mock feature requests`);
  console.log("\nNow visit: http://localhost:3000/intervention");
}
